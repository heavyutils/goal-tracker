    ...
    public partial class MainWindow : Window
    {
        ...
        private ObservableCollection<Goal> LoadGoalsFromIni(string filePath)
        {
            ...
            catch
            {
                ...
                MessageBox.Show("Welcome to the Goal Tracker! This is the perfect app to keep track of your life (or short term) goals. Right click anywhere on the blank window to get started." + Environment.NewLine + "This app is licensed under the GPL-3.0 license.", "Goal Tracker");
